        ...
        movementController.transform
            ...
            .OnComplete(() =>
            {
                ...
                DOVirtual.DelayedCall(
                    SettingsManager.Instance.GameplaySettings.baseMinTimeBetweenSkills,
                    () => parentController.SetSkillsDisabled(false, "MeleeDashAttack")
                );

                DOVirtual.DelayedCall(
                    SettingsManager.Instance.GameplaySettings.baseStaticTimeOnSkillUse,
